import{r as i,j as e}from"./index-BEiEE2Na.js";function t(){const s=i.useRef(null),l=i.useRef(null),a=i.useRef(null),r=n=>{n.preventDefault();const c={name:s.current.value,email:l.current.value,fileName:a.current.files[0]?.name||"未選擇檔案"};alert(`提交資料:
姓名: ${c.name}
Email: ${c.email}
